...
import { FileText, CheckCircle, Briefcase, Sparkles } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-sm mt-1">
          Let’s improve your chances of getting hired
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-10">
        ...
        >
          ...
          <p className="text-sm text-gray-500">Create or edit your resume</p>
        </Link>
        ...
        <Link
          ...
          className="p-6 rounded-xl border hover:shadow-md transition"
        >
          <Briefcase className="h-6 w-6 text-purple-600 mb-3" />
          <h3 className="font-semibold text-gray-900">Job Matcher</h3>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="p-5 bg-white border rounded-xl">
          <p className="text-sm text-gray-500">Resume Completeness</p>
      ...
      {/* Tips / Suggestions */}
      <div className="p-6 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 border">
        <div className="flex items-center gap-2 mb-2">
          <Sparkles className="h-5 w-5 text-blue-600" />
          <h3 className="font-semibold text-gray-900">Improve your resume</h3>
        </div>
        <p className="text-sm text-gray-600">
          Add more keywords related to your target job to increase your ATS
          score.
        </p>
      </div>
    </div>
