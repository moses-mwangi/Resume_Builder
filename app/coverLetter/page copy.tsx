...
//           return element.classList?.contains("bg-gradient-to-br");
//         },
//       });
...
const LivePreview = ({
  ...
  console.log(letterTemplates["professional"]);
  ...
  return (
    ...
    >
      <div className="px-11 py-8">
        ...
        <div className="mb-6 text-sm">{data.recipient.companyName}</div>

        {/* LETTER */}

        <p className="mb-4">
          Dear {data.recipient.hiringManager || "Hiring Manager"},
        </p>

        <p className="mb-4 whitespace-pre-wrap">{data.letter.opening}</p>

        <p className="mb-4 whitespace-pre-wrap">{data.letter.body}</p>

        <p className="mb-4 whitespace-pre-wrap">{data.letter.closing}</p>
...
export default function CoverLetterBuilder() {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<keyof typeof letterTemplates>("professional");
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex gap-2 mb-4">
          ...
          {exportSuccess && <Badge className="ml-2">Exported!</Badge>}
        </div>
        ////////////////////////////////////////////////////////////////////////////////
        // PREVIEW AREA (FIXED — WHITE BACKGROUND)
        ////////////////////////////////////////////////////////////////////////////////
        {showPreview && (
          <Card className="p-6">
            <div
            ...
            >
              <LivePreview data={letterData} template={selectedTemplate} />
            </div>
          </Card>
        )}
      </div>
